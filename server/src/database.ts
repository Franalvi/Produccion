...
try { // try catch: hace el try y si no anda hace el catch
    pool.connect('mssql://isri:isri@LAPTOP-T76T7RH8/SQLEXPRESS/Datos_Valladolid?encrypt=true'); // Usuario sql: DevIsriVa. Contraseña SQL: Dev+2021. Nombre del servidor:SRVEXPVA/dev. Base de datos: Datos_Valladolid. Lo otro se pone y punto.
